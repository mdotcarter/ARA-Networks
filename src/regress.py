...
if __name__ == "__main__":
    ...
    global_mask = (nb.load('raw_roi_timecorr_mcf_avg_brain_thr.nii.gz').get_data() > 0)
    wm_mask = (nb.load('raw_roi_timecorr_mcf_avg_wm_thr.nii.gz').get_data() > 0)
    csf_mask = (nb.load('raw_roi_timecorr_mcf_avg_csf_thr.nii.gz').get_data() > 0)
