...
ResampleVolume2 --Reference ./fmri0.nii.gz --transformationFile ./atlastot1w_affinetransform.txt --transform_order input-to-output --interpolation nn --default_pixel_value 0 ${ATLASDIR}/ROI_MNI_V4_NoCblm.nii.gz ./roi_regfmri.nii.gz
...
for l in $(ls splitlabels); do 
	...
	mv ./fmri_masked_roi/fmri_${l} ./masked_fmri/fmri_${l}
